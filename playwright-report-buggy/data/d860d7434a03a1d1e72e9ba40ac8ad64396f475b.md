...
- Name: ui/checkout.spec.ts >> User Story 8 - Complete Checkout >> negative: checkout cannot be completed when required details are missing
- Location: tests/ui/checkout.spec.ts:36:7
