...
- Name: ui/orders.spec.ts >> User Story 9 - View Order History >> positive: authenticated user can attempt to access order history route
- Location: tests/ui/orders.spec.ts:5:7
